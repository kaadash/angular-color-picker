    ...
    createClass(AngularColorPickerController, [{
        ...
        value: function initMouseEvents() {
            ...
            this.$scope.$on('$destroy', function () {
                // remove mouse events
                _this4.$document.off('mousedown.colorPicker', eventHandlers.mouseDown);
                _this4.$document.off('mouseup.colorPicker', eventHandlers.mouseUp);
                _this4.$document.off('mousemove.colorPicker', eventHandlers.mouseMove);
        ...
        key: 'onMouseDownColorGrid',
        value: function onMouseDownColorGrid(ev) {
            this.has_moused_moved = false;
            this.colorDown(ev);
        }
    }, {
        key: 'onMouseDownHue',
        value: function onMouseDownHue(ev) {
            this.has_moused_moved = false;
            this.hueDown(ev);
        }
    }, {
